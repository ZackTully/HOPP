...
class ExternallyDefinedBatteryDispatchHeuristic(SimpleBatteryDispatch):
    ...
    def set_fixed_dispatch(self, gen: list, grid_limit: list, start_time:int):
        ...
        fixed_schedule = self.external_fixed_dispatch[start_time: start_time + len(gen)] / self.maximum_power
        self._fixed_dispatch = fixed_schedule.copy()
        self.user_fixed_dispatch = fixed_schedule.copy()

        grid_limit = [10 * gl for gl in grid_limit]
